...
HEALTH_VERIFY_INTERVAL_ENV = "CURATOR_SKILL_REGISTRY_HEALTH_VERIFY_INTERVAL"
CHECKPOINT_ENV = "CURATOR_SKILL_REGISTRY_CHECKPOINT"
KEY_PASSPHRASE_ENV = "CSK_REGISTRY_KEY_PASSPHRASE"
